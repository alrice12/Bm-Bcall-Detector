...
%
filterSpec1 = '*.wav';
boxTitle1 = 'Open WAV file to Decimate';
...
PARAMS.outfile = strcat(PARAMS.infile(1:length(PARAMS.infile)-6),'.d',num2str(PARAMS.df),'.wav');
...
%nsamp = PARAMS.xhd.dSubchunkSize * 8 / PARAMS.xhd.BitsPerSample / PARAMS.xhd.NumChannels;
%
...
%     fseek(fid,PARAMS.xhd.ChunkSize + 8 - PARAMS.xhd.dSubchunkSize+...
%         (di-1)*PARAMS.xhd.BitsPerSample/4,'bof');
