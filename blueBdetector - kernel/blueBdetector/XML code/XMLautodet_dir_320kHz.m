...
%filterSpec1 = '*.txt';
%defaultName = 'E:';
outfile = 'CINMS33C_ker59H_thresh33.xls';
...
outpath = 'F:\General LF Data Analysis\B call detector\SOCAL\CINMS\';
...
xml_out= 'F:\General LF Data Analysis\B call detector\SOCAL\CINMS\CINMS33C_ker59H_thresh33.xml'; 
% -------------------------------------------------------------------------
