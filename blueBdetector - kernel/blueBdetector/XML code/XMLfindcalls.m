function XMLfindcalls (rIdx, halfblock, block, gap, offset, startTime, endTime, filename, hdr, ftype, in_fid, out_fid, DISPLAY, dxml, params)
...
XMLwritecalls (hdr, rIdx, halfblock, startTime, offset, peakS, score, out_fid, in_fid, dxml);
