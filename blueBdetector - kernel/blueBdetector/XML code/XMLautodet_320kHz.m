...
%for THRESHOLDS only, uncomment lines 19-21, and 64. Comment out line 207

% % Hardcode Options:
% directory = false; %Anaylzing a whole directory or single file?
% filename = 'H:\Blue whale D detector project\DATA\Site C\CINMS_C_32_disks01-03_df100\groundtruth\CINMS_C_32_d02_161215_074858.df100.x.wav';
% outfile = 'F:\General LF Data Analysis\Thresholds\CINMS\32C\CINMS32C_ker59H_thresh31.xls';
% xml_out='H:\\SOCAL df100 data\\Site C\\test_ad.xml'; %location of output XML, notice double backslash (java thing).
