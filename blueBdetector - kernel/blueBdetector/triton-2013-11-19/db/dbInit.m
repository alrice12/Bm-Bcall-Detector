...
parent = fileparts(which(mfilename));  % access parent directory
grandparent = fileparts(parent);
% sibiling of grandparent
xmldefaults = fullfile(grandparent, 'server', xmlServerSpec);
