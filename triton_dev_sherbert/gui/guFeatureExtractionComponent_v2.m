function varargout = guFeatureExtractionComponent_v2(varargin)
...
% Last Modified by GUIDE v2.5 27-Jan-2014 15:37:44

% Begin initialization code - DO NOT EDIT
gui_Singleton = 0;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @guFeatureExtractionComponent_v2_OpeningFcn, ...
...
function handles = guFeatureExtractionComponent_v2_OpeningFcn(hObject, eventdata, handles, varargin)
...
varargout{1}.Saturation = [...
    str2double(get(handles.(mfilename).saturationPercMin, 'String'))/100, ...
    str2double(get(handles.(mfilename).saturationPercMax, 'String'))/100,...
	str2double(get(handles.(mfilename).saturationThresholddB, 'String'))];
varargout{1}.EchoSounder = get(handles.(mfilename).saveEchoSounder, 'Value');
...
function saturationThresholddB_Callback(hObject, eventdata, handles)
% hObject    handle to saturationThresholddB (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of saturationThresholddB as text
%        str2double(get(hObject,'String')) returns contents of saturationThresholddB as a double


% --- Executes during object creation, after setting all properties.
function saturationThresholddB_CreateFcn(hObject, eventdata, handles)
% hObject    handle to saturationThresholddB (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
function saturationPercMin_Callback(hObject, eventdata, handles)
% hObject    handle to saturationPercMin (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of saturationPercMin as text
%        str2double(get(hObject,'String')) returns contents of saturationPercMin as a double


% --- Executes during object creation, after setting all properties.
function saturationPercMin_CreateFcn(hObject, eventdata, handles)
% hObject    handle to saturationPercMin (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
function saturationPercMax_Callback(hObject, eventdata, handles)
% hObject    handle to saturationPercMax (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of saturationPercMax as text
%        str2double(get(hObject,'String')) returns contents of saturationPercMax as a double


% --- Executes during object creation, after setting all properties.
function saturationPercMax_CreateFcn(hObject, eventdata, handles)
% hObject    handle to saturationPercMax (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
% --- Executes on button press in saveEchoSounder.
function saveEchoSounder_Callback(hObject, eventdata, handles)
% hObject    handle to saveEchoSounder (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hint: get(hObject,'Value') returns toggle state of saveEchoSounder
