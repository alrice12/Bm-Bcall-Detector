...
latitude = sensor(1).DeploymentDetails.Latitude{1};
longitude = sensor(1).DeploymentDetails.Longitude{1};
...
if strcmp(details(1).Kind(1).Granularity, 'binned')
    Resolution_m = str2double(details(1).Kind(1).Granularity_attr.BinSize_m);
else
