        ...
        for sidx=1:site_count
            ...
            for didx=1:depl_count
                ...
                if iseff
                    ...
                    if ~isstruct(depl_info)
                        error('Cannot find deployment information for given inputs')
                    end
                    droplat = depl_info.DeploymentDetails.Latitude{1};
                    droplon = depl_info.DeploymentDetails.Longitude{1};
                    reclat = depl_info.RecoveryDetails.Latitude{1};
                    reclon = depl_info.RecoveryDetails.Longitude{1};
