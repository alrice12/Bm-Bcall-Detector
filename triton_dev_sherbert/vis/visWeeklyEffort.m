                    ...
                    if isempty(queries(quer_count).Detections)
                        ...
                        switch(granularity)
                            case {'encounter'}
                                ...
                                interval = dep_info.SamplingDetails.Channel.DutyCycle.Regimen.RecordingInterval_m{1};
                                duration = dep_info.SamplingDetails.Channel.DutyCycle.Regimen.RecordingDuration_m{1};
